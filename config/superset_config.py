...
if invocation_type == 'COMPOSE':
    MYSQL_USER = 'superset' # get_env_variable('MYSQL_USER')
    MYSQL_PASS = 'superset' # get_env_variable('MYSQL_PASS')
    MYSQL_HOST = 'superset-mysql' #get_env_variable('MYSQL_HOST')
    MYSQL_PORT = '3306' #get_env_variable('MYSQL_PORT')
    MYSQL_DATABASE = 'superset' #get_env_variable('MYSQL_DATABASE')
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql://%s:%s@%s:%s/%s' % (MYSQL_USER,
                                                          ...
                                                          MYSQL_PORT,
                                                          MYSQL_DATABASE)
else: raise Exception("Not COMPOSE?")
...
REDIS_PORT=''
if invocation_type == 'COMPOSE':
    REDIS_HOST = 'superset-redis' #get_env_variable('REDIS_HOST')
    REDIS_PORT = '6379' #get_env_variable('REDIS_PORT')
